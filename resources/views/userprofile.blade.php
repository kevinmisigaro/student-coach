                        ...
                        <div class="card-body py-3">
                            <div class="row no-gutters align-items-center">
                                <div class="col"><a href="/post/{{ $post->id }}" class="text-big" data-abc="true">{{ $post->title }}</a>
                                    <div class="text-muted small mt-1">Started {{ $post->created_at->diffForHumans() }} &nbsp;·&nbsp; <a href="javascript:void(0)" class="text-muted" data-abc="true">{{ $post->user->username }}</a></div>
                                </div>
            ...
            <div class="col-md-3 col-sm-12 col-xs-12">
                <div class="card" style="width: 100%">
                    ...
                    <div class="text-center">
                        <img src="{{ asset('images/businessavatar.jpg') }}" alt="profile" style="border: 1px solid black;margin-top: -60px" width="100" height="100" class="rounded-circle">  
                    </div>
